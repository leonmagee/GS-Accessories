...
function gs_accessories_scripts() {
	...
	wp_register_script( 'custom-js', get_template_directory_uri() . '/js/custom.js', array('jquery', 'jquery-ui-core', 'jquery-ui-datepicker'), '1.2.17', true );
	...
	wp_register_style( 'gs-accessories-styles', get_template_directory_uri() . '/assets/css/main.min.css',  array('jquery-ui-css'), '1.2.37' );
...
function gs_accessories_admin_scritps() {
	...
	wp_register_script( 'custom-admin-js', get_template_directory_uri() . '/js/custom-admin.js', array('jquery', 'jquery-ui-core', 'jquery-ui-datepicker'), '1.1.18', true );
