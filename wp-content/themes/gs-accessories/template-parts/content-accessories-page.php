...
$counter = 1;
    foreach ($colors as $color => $quantity) {
        ...
        ?>
                                    ...
                                    <input quantity="<?php echo $quantity; ?>" class="quantity-input <?php echo $color_class . ' ' . $counter_class; ?> " name="<?php echo $namer; ?>" type="number" min="0" placeholder="Max <?php echo $quantity; ?>" />
